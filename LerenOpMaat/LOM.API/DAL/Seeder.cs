...
public class Seeder
{
    ...
    public void Seed()
    {
        ...
        _modelBuilder.Entity<Module>().HasData(
            ...
            new Module { Id = 16, Name = "Afstuderen", Code = "A.01", Description = "Afstuderen", Ec = 30, Level = 3, Period = 3, IsActive = true, GraduateProfileId = 2},
            new Module { Id = 17, Name = "Multidisciplinaire Opdracht", Code = "MDO.01", Description = "Multidisciplinaire Opdracht", Ec = 30, Level = 3, Period = 3, IsActive = true, GraduateProfileId = 2}
            );

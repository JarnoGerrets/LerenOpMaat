...
public class Seeder
{
    ...
    public void Seed()
    {
        ...
        _modelBuilder.Entity<Message>().HasData(
            new Message { Id = 1, ConversationId = 1, DateTime = DateTime.Now, Commentary = "Hoi, mag ik een feedback krijgen op mijn leerroute?", UserId = 1 , IsRead = false},
            new Message { Id = 2, ConversationId = 1, DateTime = DateTime.Now, Commentary = "Ik zou semester 2 van het jaar 2 aanpassen naar iets anders.", UserId = 3, IsRead = false },
            new Message { Id = 3, ConversationId = 1, DateTime = DateTime.Now, Commentary = "Hoi, Ik heb het aangepast", UserId = 1, IsRead = false },
            new Message { Id = 4, ConversationId = 1, DateTime = DateTime.Now, Commentary = "Leerroute ziet er goed uit!", UserId = 3, IsRead = false }
            );
